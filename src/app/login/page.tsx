    ...
    <div className="min-h-[calc(100vh-10rem)] flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="border border-[var(--border)] bg-white">
          <div className="p-8">
            <div className="text-center mb-8">
              ...
              <h1 className="text-lg font-bold tracking-tight">登录</h1>
                ...
                <div className="flex justify-center gap-2">
                  {code.map((digit, i) => (
                    <input
                      ...
                      className="w-11 h-12 text-center text-lg font-bold border border-[var(--border)] focus:border-black focus:outline-none"
                    />
                  ))}
                </div>
        ...
        <div className="text-center mt-6">
          <a href="/" className="text-[11px] text-[var(--text-tertiary)] hover:text-[var(--text-primary)] transition-colors">
            ← 返回首页
          </a>
        </div>
      </div>
